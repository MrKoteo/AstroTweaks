...
public class ElementsAstrotweaksMod implements IFuelHandler, IWorldGenerator {
	...
	public void preInit(FMLPreInitializationEvent event) {
		try {
			for (ASMDataTable.ASMData asmData : event.getAsmData().getAll(ModElement.Tag.class.getName())) {
				...
				if (clazz.getSuperclass() == ElementsAstrotweaksMod.ModElement.class)
					elements.add((ElementsAstrotweaksMod.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
		Collections.sort(elements);
		elements.forEach(ElementsAstrotweaksMod.ModElement::initElements);
		this.addNetworkMessage(AstrotweaksModVariables.WorldSavedDataSyncMessageHandler.class,
				AstrotweaksModVariables.WorldSavedDataSyncMessage.class, Side.SERVER, Side.CLIENT);
	}
	...
	public void onPlayerLoggedIn(net.minecraftforge.fml.common.gameevent.PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.player.world.isRemote) {
			WorldSavedData mapdata = AstrotweaksModVariables.MapVariables.get(event.player.world);
			WorldSavedData worlddata = AstrotweaksModVariables.WorldVariables.get(event.player.world);
			if (mapdata != null)
				AstrotweaksMod.PACKET_HANDLER.sendTo(new AstrotweaksModVariables.WorldSavedDataSyncMessage(0, mapdata),
	...
	public <T extends IMessage, V extends IMessage> void addNetworkMessage(Class<? extends IMessageHandler<T, V>> handler, Class<T> messageClass,
			Side... sides) {
		for (Side side : sides)
			AstrotweaksMod.PACKET_HANDLER.registerMessage(handler, messageClass, messageID, side);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final ElementsAstrotweaksMod elements;
		protected final int sortid;
		public ModElement(ElementsAstrotweaksMod elements, int sortid) {
