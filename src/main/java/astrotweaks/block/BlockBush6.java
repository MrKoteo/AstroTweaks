...
public class BlockBush6 extends ElementsAstrotweaksMod.ModElement {
	@GameRegistry.ObjectHolder("astrotweaks:bush_6")
	public static final Block block = null;
	public BlockBush6(ElementsAstrotweaksMod instance) {
		super(instance, 736);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("astrotweaks:bush_6", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockBush {
		public BlockCustomFlower() {
			...
			setHardness(0F);
			setResistance(0F);
			setUnlocalizedName("bush_6");
			setRegistryName("bush_6");
		}
