...
//import astrotweaks.procedure.ProcedureMTInitProc;
...
public class BlockMoneyTable extends ElementsAstrotweaksMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "astrotweaks:tileentitymoney_table");
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("money_table");
