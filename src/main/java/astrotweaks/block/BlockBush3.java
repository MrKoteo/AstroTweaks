...
public class BlockBush3 extends ElementsAstrotweaksMod.ModElement {
	@GameRegistry.ObjectHolder("astrotweaks:bush_3")
	public static final Block block = null;
	public BlockBush3(ElementsAstrotweaksMod instance) {
		super(instance, 733);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("astrotweaks:bush_3", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockBush {
		public BlockCustomFlower() {
			...
			setHardness(0F);
			setResistance(0F);
			setUnlocalizedName("bush_3");
			setRegistryName("bush_3");
		}
		@Override
